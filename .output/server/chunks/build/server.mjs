...
const _routes = [
  ...
  },
  {
    name: "register",
    path: "/register",
    component: () => import('./register-CoKD0fbn.mjs')
  },
  {
    name: "order-new",
    path: "/order/new",
  ...
  },
  {
    name: "orders-id",
    path: "/orders/:id()",
    component: () => import('./_id_-BLMVcaZz.mjs')
  },
  {
    name: "orders",
    path: "/orders",
    component: () => import('./index-C1PPbR2H.mjs')
  },
  {
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-h4PiWLtc.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-D1NvwtEE.mjs'));
...
export { _export_sfc as _, useRoute as a, useRuntimeConfig as b, useRouter as c, useNuxtApp as d, entry_default as default, encodeRoutePath as e, nuxtLinkDefaults as f, navigateTo as n, resolveRouteObject as r, tryUseNuxtApp as t, useAuthStore as u };
