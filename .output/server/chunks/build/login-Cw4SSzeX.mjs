...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<button class="btn primary"${ssrIncludeBooleanAttr(unref(loading)) ? " disabled" : ""}>${ssrInterpolate(unref(loading) ? "Signing in\u2026" : "Sign in")}</button><div class="help"> Ch\u01B0a c\xF3 t\xE0i kho\u1EA3n? `);
...
//# sourceMappingURL=login-Cw4SSzeX.mjs.map
